...
int main(){
    ...
    //Print out the sizes
    std::cout << "size floa: " << sizeof(float) << std::endl;
    std::cout << "size double: " << sizeof(double) << std::endl;
    std::cout << "size long double: " << sizeof(long double) << std::endl;
    ...
    double number4 {192400023.0123456789}; // Error: narrowing conversion, to much digits, float precission is 7 this number including the whole number is bigger than the limitation
